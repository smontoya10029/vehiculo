  ...
  <div id="app">
    <v-app>
      <v-main>   
       ...
       <v-btn class="mx-4 mt-8"  fab dark color="#00B0FF" @click="formNuevo()"><v-icon dark>mdi-plus</v-icon></v-btn>           
       </v-  flex> 
       
       <a class="btn btn-lg btn-primary" href="{{ route('encargado.show') }}" role="button"> Crear encargado vehicular</a>
      ...
      <v-dialog v-model="dialog" max-width="500">        
        <v-card>
          <v-card-title class="blue darken-2 white--text">CREAR VEHICULOS</v-card-title>    
          <v-card-text>            
            <v-form>             
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" md="4">
                    <v-text-field v-model="empleado.nombre" label="Nombre" solo required></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="empleado.apellido" label="Apellido" solo required></v-text-field>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-text-field v-model="empleado.telefono" label="Telefono" type="number" solo required></v-text-field>
                  </v-col>
                </v-row>
              </v-container>              
          </v-card-text>
