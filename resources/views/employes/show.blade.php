    ...
    <v-app>
      <v-main>   
       ...
       <v-btn class="mx-2 mt-4"  fab dark color="#00B0FF" @click="formNuevo()"><v-icon dark>mdi-plus</v-icon></v-btn>           
        ...
        <a class="btn btn-lg btn-primary" href="{{ route('vehiculo.show') }}" role="button"> Vista vehicular</a>
              ...
              <template v-slot:default>
                  <thead>
                      <tr class="indigo darken-4">
                          ...
                          <th class="white--text text-center">CIUDAD</th>
                          <th class="white--text text-center">TIPO_VEHICULO</th>
                  ...
                  <tbody>
                      <tr v-for="empleado in employes" :key="empleado.id">
                          ...
                          <td class="text-center">{{ empleado.ciudad }}</td>
                          <td class="text-center">{{ empleado.tipo_vehiculo }}</td>
                          <td>
